 ...
 */
@Component
public class RequestManyNoPolicyTrial extends AbstractPalisadeTrial {
    protected static final String NAME = "request_many_no_policy";
    private static final String DESCRIPTION = "makes a request for many files with no policy set without reading data";
